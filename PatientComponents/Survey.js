      ...
      <View style={styles.view1}>
        ...
        <View style={styles.view8}>
          <View style={styles.question}>
            <Text style={styles.text2}>
              1. Do you frequently forget recent events or conversations?
            </Text>
          </View>
        ...
        <View style={styles.view8}>
          <View style={styles.question}>
            <Text style={styles.text2}>
              2. Have you noticed an increase in misplacing items, such as keys
              or wallet
            </Text>
          </View>
          <View style={styles.option}>
        ...
        <View style={styles.view8}>
          <View style={styles.question}>
            <Text style={styles.text2}>
              3. Do you find it difficult to follow conversations?
            </Text>
          </View>
          <View style={styles.option}>
            <Image
        ...
        <View style={styles.view36}>
          <Pressable onPress={() => navigation.navigate('FirstPagePatient')}>
